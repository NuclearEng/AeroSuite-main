...
describe('AIAnalysisPage', () => {
  ...
  it('shows success on valid analysis', async () => {
    axios.post.mockResolvedValueOnce({ data: { analysis: { summary: { value: { min: 1, max: 2, mean: 1.5 } } } } });
    renderWithProviders(<AIAnalysisPage />);
  ...
  it('shows error on large file upload', () => {
    ...
    fireEvent.change(uploadBtn.querySelector('input[type="file"]'), { target: { files: [file] } });
