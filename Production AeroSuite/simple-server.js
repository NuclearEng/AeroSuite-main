...
app.get('/', (req, res) => {
  ...
  if (fs.existsSync(dashboardPath)) {
    ...
    res.send('<h1>AeroSuite API</h1><p>API is running. Dashboard not found.</p>');
  }
});

// All alternate dashboard routes have been removed - only main dashboard is available
...
// Add missing endpoints for reports and inspectors
app.get('/api/reports', (req, res) => {
  res.json({ 
    success: true, 
    data: [
      { id: '1', name: 'Quality Assurance Report - Q2 2023', type: 'quality', date: '2023-06-30' },
      { id: '2', name: 'Supplier Performance Review', type: 'supplier', date: '2023-07-15' },
      { id: '3', name: 'Compliance Audit Summary', type: 'compliance', date: '2023-07-01' }
    ]
  });
});
...
app.get('/api/inspectors', (req, res) => {
  res.json({ 
    success: true, 
    data: [
      { id: '1', name: 'John Smith', email: 'john.smith@aerosuite.com', specialization: 'Quality Control' },
      { id: '2', name: 'Sarah Johnson', email: 'sarah.johnson@aerosuite.com', specialization: 'Safety' },
      { id: '3', name: 'Robert Davis', email: 'robert.davis@aerosuite.com', specialization: 'Compliance' },
      { id: '4', name: 'Emily Wilson', email: 'emily.wilson@aerosuite.com', specialization: 'Quality Control' },
      { id: '5', name: 'Michael Brown', email: 'michael.brown@aerosuite.com', specialization: 'Environmental' }
    ]
  });
});
